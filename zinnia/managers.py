...
class EntryRelatedPublishedManager(models.Manager):
    ...
    def get_queryset(self):
        ...
        now = timezone.now()
        return (
            super(EntryRelatedPublishedManager, self)
            .get_queryset()
            .filter(
                models.Q(entries__start_publication__lte=now) | models.Q(entries__start_publication=None),
                models.Q(entries__end_publication__gt=now) | models.Q(entries__end_publication=None),
