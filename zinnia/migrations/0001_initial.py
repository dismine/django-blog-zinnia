    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="Used to build the category's URL.", unique=True, max_length=255, verbose_name="slug"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comment_enabled",
                    models.BooleanField(
                        default=True, help_text="Allows comments if checked.", verbose_name="comments enabled"
                    ),
                ),
                (
                    "pingback_enabled",
                    models.BooleanField(
                        default=True, help_text="Allows pingbacks if checked.", verbose_name="pingbacks enabled"
                    ),
                ),
                (
                    "trackback_enabled",
                    models.BooleanField(
                        default=True, help_text="Allows trackbacks if checked.", verbose_name="trackbacks enabled"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[("entry_detail.html", "Default template")] + zinnia.settings.ENTRY_DETAIL_TEMPLATES,
                    ),
                ),
                (
                    "categories",
                    models.ManyToManyField(
                        related_name="entries", verbose_name="categories", to="zinnia.Category", blank=True
                    ),
                ),
                (
                    "related",
                    models.ManyToManyField(
                        related_name="related_rel_+", verbose_name="related entries", to="zinnia.Entry", blank=True
                    ),
                ),
                (
                    "sites",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="entries", verbose_name="authors", to="zinnia.Author", blank=True
            ),
