...
class MPTTFilteredSelectMultiple(widgets.FilteredSelectMultiple):
    ...
    def optgroups(self, name, value, attrs=None):
        ...
        for index, (option_value, option_label, sort_fields) in enumerate(chain(self.choices)):
            ...
            for subvalue, sublabel in choices:
                selected = force_str(subvalue) in value and (has_selected is False or self.allow_multiple_selected)
